...
/* Selectbox */[data-testid="stSelectbox"] > div > div {
...
/* Métricas nativas */
[data-testid="metric-container"] { background: white; border-radius: 8px; padding: 12px; border: 1px solid #dee2e6; }[data-testid="metric-container"] label { color: #555555 !important; }[data-testid="metric-container"] [data-testid="stMetricValue"] { color: #003F8A !important; font-weight: 900 !important; }
