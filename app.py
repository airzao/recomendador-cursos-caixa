  ...
  <p style="margin:10px 0 0 0;color:rgba(255,255,255,0.75);font-size:0.85rem;">
    Confiança do modelo para este perfil
        ...
        with col_v2:
            ...
            st.markdown(f"""
<div style="background:white;padding:20px;border-radius:10px;border-left:5px solid {CA_AZUL};box-shadow:0 2px 8px rgba(0,112,184,0.1);">
  <h4 style="color:{CA_AZUL};margin-top:0;margin-bottom:12px;">👤 Perfil Analisado</h4>
  <p style="margin:4px 0;color:{CA_CINZA};font-size:0.88rem;"><b>Área:</b> {perfil['area']}</p>
  <p style="margin:4px 0;color:{CA_CINZA};font-size:0.88rem;"><b>Cargo:</b> {perfil['funcao']}</p>
  <p style="margin:4px 0;color:{CA_CINZA};font-size:0.88rem;"><b>Casa:</b> {perfil['tempo_de_casa']} anos</p>
  <p style="margin:4px 0;color:{CA_CINZA};font-size:0.88rem;"><b>Já usou IA:</b> {perfil['ja_utilizou_ia']}</p>
  <p style="margin:4px 0;color:{CA_CINZA};font-size:0.88rem;"><b>Programação:</b> {perfil['nivel_programacao']}</p>
...
| **Meta** | Logistic Regression | cv=5 | Combina as 3 predições |
        """)
        st.markdown(f"""
<div style="background:{CA_CLARO};padding:14px 18px;border-radius:8px;border-left:5px solid {CA_AZUL};margin-top:12px;">
  <p style="margin:0;color:{CA_CINZA};font-size:0.92rem;">
    <b style="color:{CA_AZUL};">Por que Stacking?</b> Cada algoritmo captura um aspecto diferente dos dados.
    ...
    with t1:
        st.markdown(f"""
<div style="background:white;padding:16px;border-radius:8px;border-left:4px solid {CA_AZUL};box-shadow:0 2px 8px rgba(0,112,184,0.08);">
  <p style="color:{CA_CINZA};margin:4px 0;"><b>🔄 Desbalanceamento:</b> class_weight='balanced'</p>
  <p style="color:{CA_CINZA};margin:4px 0;"><b>🔧 Pipeline:</b> OneHotEncoder + StandardScaler</p>
  <p style="color:{CA_CINZA};margin:4px 0;"><b>🛡️ Data Leakage:</b> fit() só no X_train</p>
</div>""", unsafe_allow_html=True)
    with t2:
        st.markdown(f"""
<div style="background:white;padding:16px;border-radius:8px;border-left:4px solid {CA_LARANJA};box-shadow:0 2px 8px rgba(245,166,35,0.08);">
  <p style="color:{CA_CINZA};margin:4px 0;"><b>✅ Validação:</b> StratifiedKFold (5 folds)</p>
  <p style="color:{CA_CINZA};margin:4px 0;"><b>📊 Métrica:</b> Macro F1-Score</p>
