...
<div class="banner-white" 
  ...
  <p style="margin:8px 0 0 0;font-size:1.05rem;opacity:0.9;">
    ...
    <span style="background:{CA_LARANJA};padding:2px 10px;border-radius:12px;font-size:0.85rem;font-weight:700;">ML • Stacking Classifier</span>
  </p>
</div>
""", unsafe_allow_html=True)
...
<div class="banner-white" 
  ...
  <p style="margin:0;font-size:1rem;line-height:1.7;">
    ...
    desenvolvido com
    <span style="font-weight:700;">Machine Learning supervisionado</span>.
    O modelo atinge
    <span style="font-weight:700;">92,8% de acurácia</span>
    e garante que o curso ideal esteja entre os 3 recomendados em
    <span style="font-weight:700;">99% dos casos</span>.
  </p>
</div>
""", unsafe_allow_html=True)
